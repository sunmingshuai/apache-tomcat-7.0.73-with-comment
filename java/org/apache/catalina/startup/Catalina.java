...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        // TODO :NamingContextListener AprLifecycleListener JasperListener
	    // TODO :JreMemoryLeakPreventionListener GlobalResourcesLifecycleListener(jmx) ThreadLocalLeakPreventionListener
    ...
    public void load() {
        ...
        //catalina.home catalina.base是否存在验证
        initDirs();
        ...
        // Digester是一套封装好的解析xml文档的框架 易于阅读 即便不了解工作原理 也很容易从方法名等角度推测出来方法的意思
	    // 读者也可以自己查询一些Digester相关文档
