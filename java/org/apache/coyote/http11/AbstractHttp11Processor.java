...
public abstract class AbstractHttp11Processor<S> extends AbstractProcessor<S> {
    ...
    /**
     * ps要做nginx拦截 否则会有包括静态文件在内的多个连接 包括静态文件的请求 比较浪费资源
    ...
    public SocketState process(SocketWrapper<S> socketWrapper)
        throws IOException {
	    /**
	     * @see Http11Protocol.Http11ConnectionHandler#createProcessor()
	     */
        ...
        //Sun: socket input/output stream
        ...
        readComplete = true;
        if (endpoint.getUsePolling()) {//false
            keptAlive = false;
        } else {
        ...
        while (!getErrorState().isError() && keepAlive && !comet && !isAsync() &&
            ...
            try {
                ...
                //解析请求行 METHOD SP Request-URI SP HTTP-Version CRLF
            ...
            if (!getErrorState().isError()) {
                try {
                    ...
                    setCometTimeouts(socketWrapper);//NO-OP for BIO
    ...
    protected void prepareRequest() {
        ...
        prepareRequestInternal();//NO-OP for BIO
