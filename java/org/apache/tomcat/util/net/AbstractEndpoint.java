...
public abstract class AbstractEndpoint<S> {
    ...
    private int maxConnections = 10000;//初始化的时候被设置为0
    ...
    /**
     * tomcat的默认最大线程数 由server.xml中Connector标签的maxThreads设置
    ...
    public void createExecutor() {
        ...
        TaskThreadFactory tf = new TaskThreadFactory(getName() + "-exec-", daemon, getThreadPriority());//TP-exec-
        executor = new ThreadPoolExecutor(getMinSpareThreads(), getMaxThreads(), 60, TimeUnit.SECONDS,taskqueue, tf);//10 200
